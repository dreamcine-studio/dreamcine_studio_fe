...
<div className="min-h-screen">
  <div className="rounded-lg dark:bg-boxdark">
    <div className="border-b border-stroke px-6 py-4 dark:border-strokedark">
      <h3 className="text-xl font-semibold text-black dark:text-white uppercase">Add Movie Data</h3>
    </div>
    ...
    <form onSubmit={storeMovie} className="py-5">
      <div className="p-6 space-y-6 md:space-y-8"> {/* Spacing between inputs */}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="mb-6">
            ...
            <input
              ...
              className="w-full rounded-lg border border-stroke bg-transparent px-4 py-3 font-medium text-black dark:text-white outline-none focus:ring-2 focus:ring-blue-600 transition"
            />
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="mb-6">
            ...
            <input
              ...
              className="w-full cursor-pointer rounded-lg border border-stroke bg-transparent font-medium outline-none transition file:border-0 file:bg-white file:px-4 file:py-2 file:hover:bg-blue-600 file:hover:bg-opacity-10 dark:border-form-strokedark dark:file:bg-white/30 dark:file:text-white dark:focus:ring-2 dark:focus:ring-blue-600 dark:text-white"
            />
          </div>
        ...
        <button
          type="submit"
          className="w-full rounded-lg bg-blue-600 py-3 text-white font-medium hover:bg-blue-700 focus:ring-2 focus:ring-blue-600 transition"
        >
          Create
        </button>
      </div>
