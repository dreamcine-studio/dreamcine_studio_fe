...
export default function GenreCreate() {
  ...
  return (
    <div className="flex flex-col gap-9 min-h-screen">
      <div className="rounded-sm dark shadow-default dark:bg-boxdark">
          ...
          <div className="p-6.5 flex flex-col gap-5">
            ...
            <div className="mb-4.5">
              ...
              <textarea
                ...
                onChange={handleInputChange}
                className="w-full rounded border-[1.5px] border-stroke bg-transparent px-5 py-3 font-normal text-black outline-none transition focus:border-blue-600 active:border-blue-600 disabled:cursor-default disabled:bg-whiter dark:border-form-strokedark dark:bg-form-input dark:focus:border-blue-600 dark:text-white resize-none"
              ></textarea>
            </div>
