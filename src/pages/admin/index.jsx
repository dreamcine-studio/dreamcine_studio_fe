...
if (error){
  ...
  <section className="grid grid-cols-3 bg-white divide-x w-full rounded-lg">
  ...
  <div className="flex flex-col h-full w-full mx-auto space-y-6">
    <section className="flex flex-col mx-auto bg-white rounded-lg p-6 shadow-md space-y-6 w-full">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 w-full min-w-0">
        ...
        {/* Seats */}
        <div className="fa-solid fa-chair fa-lg flex flex-col px-6 py-2 bg-white shadow rounded-lg overflow-hidden">
          <div className="flex flex-col items-center space-y-2">
        ...
        <div className="fa-solid fa-calendar-days fa-xl flex flex-col px-6 py-2 bg-white shadow rounded-lg overflow-hidden">
          <div className="flex flex-col items-center space-y-2">
            <div className="text-7xl font-extrabold tracking-tight leading-none text-primary-900">{Schedules.length}</div>
        ...
        <div className="fa-solid fa-cart-shopping fa-lg flex flex-col px-6 py-2 bg-white shadow rounded-lg overflow-hidden">
          <div className="flex flex-col items-center space-y-2">
            <div className="text-7xl font-extrabold tracking-tight leading-none text-primary-900">{Bookings.length}</div>
        ...
        <div className="fa-solid fa-money-bill fa-lg flex flex-col px-6 py-2 bg-white shadow rounded-lg overflow-hidden">
          <div className="flex flex-col items-center space-y-2">
            <div className="text-7xl font-extrabold tracking-tight leading-none text-primary-900">{Payments.length}</div>
            <div className="text-lg font-medium text-primary-900">Payments</div>
          </div>
        </div>

        {/* Users */}
        <div className="fa-solid fa-user fa-lg flex flex-col px-6 py-2 bg-white shadow rounded-lg overflow-hidden">
          <div className="flex flex-col items-center space-y-2">
            <div className="text-7xl font-extrabold tracking-tight leading-none text-primary-900">{users.length}</div>
            <div className="text-lg font-medium text-primary-900">Users</div>
          </div>
        </div>
