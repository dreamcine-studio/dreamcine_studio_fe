...
import {
  deleteScheduleShowtimes,
  getScheduleShowtimes,
} from "../../../services/scheduleshowtime";
                  ...
                  >
                    ...
                    <td className="py-4 px-4">
                      <span className="px-3 py-1 bg-gray-300 text-gray-700 rounded-md text-black">
                        {showtimes
                          .find((s) => s.id === scheduleShowtime.showtime_id)
                          ?.sequence.slice(0, 5) || "No Showtime"}
                      </span>
                    </td>
                    ...
                    <td className="py-4 px-4">
                      <div className="flex items-center space-x-3.5">
                        <Link
                          to={`/admin/schedule_showtimes/edit/${scheduleShowtime.id}`}
                        >
