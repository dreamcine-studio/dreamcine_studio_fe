...
export default function StudioEdit() {
    ...
    const fetchStudioDetails = async () =>{
      ...
      const studio = data.find(studio => studio.id === parseInt(id));
      // console.log(book)
      if(studio){
  ...
  // untuk menjalakan fetch nya, kayka function biasa
    ...
    // ini untuk ke form
    const updateStudiosDetails =  async (e) =>{
      e.preventDefault()
    ...
    return (
      <div className="flex flex-col gap-9">
        ...
        >
          ...
          <form onSubmit={updateStudiosDetails} className="py-5">
            <div className="p-6.5 flex flex-col gap-5">
              ...
              <div className="mb-4.5">
                ...
                {errors.maxseat && (
                <div className="p-2 my-2 text-sm text-red-800 rounded-lg bg-red-50">
                    <span className="font-medium">{errors.maxseat[0]}</span>
                </div>
              )}
