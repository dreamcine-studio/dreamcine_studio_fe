            ...
            <div className="w-full p-4" ref={scheduleRef}>
              ...
              {selectedShowtime && (
                <div className="mt-4 p-4 bg-gray-200 rounded-lg">
                  ...
                  <Link
                    to={`/booking-seat?schedule_id=${selectedShowtime.id}&movie_id=${movie.id}&showtime=${selectedShowtime.time}&showdate_start=${selectedShowtime.showdate_start}&studio_id=${selectedShowtime.studio_id}`}
                    className="bg-indigo-600 flex gap-2 items-center text-white px-6 py-2 rounded-md hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2"
                  >
                    <i className="fa-solid fa-ticket"></i>
